...
if(NOT EXISTS "Q:/Ethereal/build/install_manifest.txt")
  message(FATAL_ERROR "Cannot find install manifest: Q:/Ethereal/build/install_manifest.txt")
endif()

# remove files from 'install_manifest.txt'
message(STATUS "")
message(STATUS "Removing files from 'install_manifest.txt'")
file(READ "Q:/Ethereal/build/install_manifest.txt" files)
...
delete_empty_folder("C:/Program Files (x86)/Ethereal/include")
delete_empty_folder("C:/Program Files (x86)/Ethereal/bin")
delete_empty_folder("C:/Program Files (x86)/Ethereal/lib/cmake")
delete_empty_folder("C:/Program Files (x86)/Ethereal/lib")
message(STATUS "")
